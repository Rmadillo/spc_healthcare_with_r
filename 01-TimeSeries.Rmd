...
R has been used by statisticians and data scientists for years, but it is rapidly becoming the *lingua franca* of business intelligence. Creating SPC charts can take hours in Excel or Tableau, but can be done in seconds with a line or two of R code.  
