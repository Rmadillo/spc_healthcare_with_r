...
# WHAT DOES THIS KIND OF CHART TELL YOU AND INTERP IT

This chart shows us that data (blue dot) and simuations from that data (orange open circles) are most consistent with a gamma distribution and a perhaps a lognormal distribution. Using `qqPlot` lets us evaluate these two options directly:    
