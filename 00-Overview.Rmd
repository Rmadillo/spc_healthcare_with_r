...
Note that some of the control chart guidelines for detecting special causes suggest that some special cause variation has occurred in this data (those guidelines can be seen in [Chapter 3](#guidelines)). Since this dataset was generated using random numbers from a known normal distribution, these are *False Positives*: the control chart suggests something has changed when in reality it hasn't. 
