...
We assume you already have a basic understanding of SPC approaches and analytics, such as knowing the difference between special cause and common cause variation, and know generally what a control chart is meant to do. We don't cover these concepts except in cases where there is often misunderstandings and bad advice; see the chapter on [Useful Reference](#useful) for books and papers that can provide introductory ideas as well as advanced practices.   
...
install.packages("forecast", "fpp2", "ggExtra", "ggseas", "gridExtra", "tidyverse", 
