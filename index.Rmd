...
This book was created using R version 3.3.1 and RStudio 1.0.44. Code was tested on Mac OS 10.10.5 (aka Yosemite), Ubuntu 14.04 (aka Trusty Tahr), and Windows Server 2008 R2 (aka piece of shit OS that crashes RStudio when you try to use the Save button).    
...
Once both are installed on your system, open RStudio and install the packages used in this book by copying and pasting this code into the **Console**:
...
# Create the u-chart
qic(y = pcmanufact$x, n = pcmanufact$size, chart = "u")
```
