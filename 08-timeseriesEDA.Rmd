...
With the `df_ts`, there is no autocorrelation and no obvious pattern:  
...
But with the `beer` data, the patterning is obvious, especially at lags 2 (6 months apart) and 4 (1 year apart):  
