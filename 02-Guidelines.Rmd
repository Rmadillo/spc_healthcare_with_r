...
|  |  | 
| *Number of crossings:* Too many or too few median line crossings suggest a pattern inconsistent with natural variation [see Chapter 6.1] (LINK ME). | *Number of crossings:* Too many or too few center line crossings suggest a pattern inconsistent with natural variation (**[see Chapter 6.1] (LINK ME)).** | 
|  |  | 
| *Trend:* Seven or more consecutive points all increasing or all decreasing (though this can be an ineffective indicator [[@AnhøjOlesen2014]]). | *Trend:* Seven or more consecutive points all increasing or all decreasing (though this can be an ineffective indicator [[@AnhøjOlesen2014]]).  | 
|  |  | 
