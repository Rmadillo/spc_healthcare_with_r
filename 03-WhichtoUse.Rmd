...
A run chart can monitor a metric or a process, while a control chart monitors a process. Always create a run chart. Create a control chart only if you meet the necessary conditions, particularly that of monitoring a *stable* process.  
