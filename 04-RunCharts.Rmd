...
But sometimes you have a trend that lasts for a long time, or is continuously trending. You can difference it to remove the trend, but that makes it harder to interpret. Perhaps a better idea is use quantile regression to obtain the median line, which allows you to keep the data on the original scale.  

```{r quantreg, fig.height=3.5}
