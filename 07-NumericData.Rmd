...
Look at the *MR* part first; if it's in control, then any special cause variation in the *I* portion can be attributed to a change in process. If it's out of control, the control limits for the *I* portion will be wrong, and should not be interpreted.  ISN'T THIS THE CASE BELOW?
